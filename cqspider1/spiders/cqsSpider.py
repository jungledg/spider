...
from cqspider1.FilterForJJ import *
import sys
reload(sys)
...
class cqspider1(CrawlSpider):
    ...
    cqs_url = 'http://spb.cq.gov.cn/SPB_ClassArticleList_Index.asp?ClassID=1814'
    ...
    def parse(self, response):
        for element in response.xpath('//td[@class="ArticleTitle1"]/a').extract():
            ...
            if pos > -1:
                ...
                m_url = '%s&page=%d' % (cqspider1.cqs_url,cqspider1.page)
                print 'm_url=',m_url
